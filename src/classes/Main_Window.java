...
public class Main_Window extends JFrame {
	...
	public Main_Window() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Main_Window.class.getResource("/images/home.png")));
		setTitle("Mass Gym || Your Health Is Our Aim || Home Page");
		...
		JMenuItem mntmPayFees = new JMenuItem("Pay Fees");
		mntmPayFees.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Add_Fees payfee= new Add_Fees();
				payfee.setVisible(true);
			}
		});
		mnPayments.add(mntmPayFees);
		...
		JMenuItem mntmShowTrainers = new JMenuItem("Show Trainers");
		mntmShowTrainers.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				
			}
		});
		mnNewMenu.add(mntmShowTrainers);
		
		JMenuItem mntmAllReports = new JMenuItem("All Reports");
		mntmAllReports.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Reports r = new Reports();
				r.setVisible(true);
			}
		});
		mnNewMenu.add(mntmAllReports);
		...
		JMenuItem mntmGenrealEnquiry = new JMenuItem("Add Enquiry");
		mntmGenrealEnquiry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Add_Enquiry enqform = new Add_Enquiry();
				enqform.setVisible(true);
			}
		});
		
		JMenuItem mntmShowAll_1 = new JMenuItem("Show All");
		mntmShowAll_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				View_Enquiry ve=new View_Enquiry();
				ve.show();
			}
		});
		mnNewMenu_2.add(mntmShowAll_1);
		...
		mnEquipments.setIcon(new ImageIcon("E:\\I MCA\\3rd Year\\VI\\PROJECT\\Gym Management System\\src\\images\\product.png"));
		mnEquipments.setFont(new Font("Dialog", Font.BOLD, 12));
		menuBar.add(mnEquipments);
		
		JMenuItem mntmAddEquipment = new JMenuItem("Add Equipment");
		mntmAddEquipment.setIcon(new ImageIcon("E:\\I MCA\\3rd Year\\VI\\PROJECT\\Gym Management System\\src\\images\\add product.png"));
		mntmAddEquipment.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Add_Equipment eq = new Add_Equipment();
				eq.setVisible(true);
			}
		});
		mnEquipments.add(mntmAddEquipment);
		
		JMenuItem mntmShowAll_2 = new JMenuItem("Show All");
		mntmShowAll_2.setIcon(new ImageIcon(Main_Window.class.getResource("/images/show.png")));
		mntmShowAll_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Show_Equipments allequp = new Show_Equipments();
				allequp.setVisible(true);
			}
		});
		mnEquipments.add(mntmShowAll_2);
		
		JMenu mnTrainer = new JMenu("Trainer");
		mnTrainer.setIcon(new ImageIcon(Main_Window.class.getResource("/images/add user.png")));
		mnTrainer.setFont(new Font("Dialog", Font.BOLD, 12));
		menuBar.add(mnTrainer);
		
		JMenuItem mntmAddTrainer = new JMenuItem("Add Trainer");
		mntmAddTrainer.setIcon(new ImageIcon(Main_Window.class.getResource("/images/add user.png")));
		mntmAddTrainer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Add_Trainer tran = new Add_Trainer(); 
				tran.setVisible(true);
			}
		});
		mnTrainer.add(mntmAddTrainer);
		
		JMenuItem mntmAllTrainers = new JMenuItem("All Trainers");
		mntmAllTrainers.setIcon(new ImageIcon(Main_Window.class.getResource("/images/show all.png")));
		mntmAllTrainers.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Show_Trainers alltran = new Show_Trainers();
				alltran.setVisible(true);
			}
		});
		mnTrainer.add(mntmAllTrainers);
		...
		lblCurretntDateAnd.setForeground(new Color(0, 0, 205));
		...
		Datetime.setForeground(new Color(0, 0, 205));
		Datetime.setBounds(1115, 657, 202, 16);
		...
		contentPane.add(bg);
		bg.setIcon(new ImageIcon(Main_Window.class.getResource("/images/flower.jpeg")));
	}
