...
public class Update_Fee_Value extends JFrame {
		 ...
		 String sql1="select * from fees";
	       try {
		       ...
		       /* int ino=0;
		        ...
		        int feeidno = Integer.parseInt( txtFeeIDn.getText());
		        int feedur =  Integer.parseInt( txtDur.getText());
		        int amt = Integer.parseInt( txtAmnt.getText());
		        
		        pst.setInt(1,feeidno);
		        pst.setInt(2,feedur);
		        pst.setInt(3,amt);
	...
	public Update_Fee_Value() {
		...
		btnUpdate.setBounds(70, 138, 100, 23);
		...
		btnCancel.setBounds(180, 138, 93, 23);
