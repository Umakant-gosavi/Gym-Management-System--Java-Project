...
public class Show_All_Product extends JFrame {
	...
	private JLabel lblAddingNewProduct;
	public JButton btnUpdate,btnSave;
	/**
	...
	{				
		String sql="Select product_id as'Product ID',product_name as 'Product Name',category as 'Category',sell_price as 'Price', opening_stock as 'Quantity',description as 'Discription' from product";
        try{
	...
	public Show_All_Product() {
		setTitle("Mass Gym || All Products");
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(pst.execute())
				{
					JOptionPane.showMessageDialog(Product_Table, "Sorry product is not cleared");
				}
				else
				{
		...
		btnUpdate_1.setIcon(new ImageIcon(Show_All_Product.class.getResource("/images/update_version.png")));
		btnUpdate_1.setFont(new Font("Tahoma", Font.BOLD, 13));
		btnUpdate_1.setBounds(599, 61, 102, 23);
