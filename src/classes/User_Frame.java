...
public class User_Frame extends JFrame {
	...
	public User_Frame() {
		...
		setTitle("Mass Gym || Your Fitness Is Our Aim");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(0, 0, 1373, 724);
		...
		lblCurretntDateAnd.setBounds(907, 636, 167, 23);
		...
		Datetime.setBounds(1081, 609, 195, 71);
		contentPane.add(Datetime);
		
		JLabel bg = new JLabel("");
		bg.setBounds(0, 32, 1354, 648);
		contentPane.add(bg);
		bg.setIcon(new ImageIcon(User_Frame.class.getResource("/images/Backg.jpg")));
	}
