...
public class Search_Member extends JFrame {
	...
	public Search_Member() {
		setTitle("Mass Gym || Search Member");
		setResizable(false);
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setBounds(250, 200, 860, 446);
		...
		btnCancel.setBounds(738, 384, 106, 23);
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					rs.next();
					{
						...
						//ltotfee.setText(rs.getString("total_fee"));
						//lpfee.setText(rs.getString("paid_fee"));
		...
		btnDelete.setBounds(609, 384, 106, 23);
		contentPane.add(btnDelete);
		
		JLabel lblTotalFees = new JLabel("Total Fees");
		lblTotalFees.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		lblTotalFees.setBounds(317, 325, 107, 22);
		contentPane.add(lblTotalFees);
		
		JLabel lblPaidFees = new JLabel("Paid Fees");
		lblPaidFees.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		lblPaidFees.setBounds(317, 359, 107, 22);
		contentPane.add(lblPaidFees);
		
		JLabel ltotfee = new JLabel("");
		ltotfee.setBounds(434, 331, 104, 16);
		contentPane.add(ltotfee);
		
		JLabel lpfee = new JLabel("");
		lpfee.setBounds(434, 359, 104, 16);
		contentPane.add(lpfee);
