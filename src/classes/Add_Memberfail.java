...
public class Add_Memberfail extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Add_Memberfail frame = new Add_Memberfail();
	...
	public Add_Memberfail() {
		setTitle("Mass Gym || Adding New Member");
		setResizable(false);
		...
		lblWeight.setBounds(194, 238, 128, 14);
		...
		lblDuration.setBounds(194, 288, 118, 14);
		contentPane.add(lblDuration);
		
		JLabel lblPaidfee = new JLabel("Paid Fee");
		lblPaidfee.setForeground(Color.BLUE);
		...
		lblStatus.setBounds(194, 263, 118, 14);
		...
		lblEnddate.setBounds(526, 201, 127, 29);
		...
		btnUpload.setIcon(new ImageIcon(Add_Memberfail.class.getResource("/images/upload.png")));
		...
		btnDelete.setIcon(new ImageIcon(Add_Memberfail.class.getResource("/images/delete.png")));
		...
		txtWeight.setBounds(322, 235, 181, 20);
		...
		cmbxStatus.setBounds(322, 260, 181, 20);
		...
		lblCountry.setBounds(194, 176, 118, 20);
		...
		cmbxDuration.setBounds(322, 285, 181, 20);
		...
		comboCountry.setModel(new DefaultComboBoxModel(new String[] {"India", "Nepal", "Japan", "Bangladesh", "Bhutan", "America", "Maldivs"}));
		comboCountry.setBounds(322, 173, 181, 20);
		...
		btnSave.setIcon(new ImageIcon(Add_Memberfail.class.getResource("/images/save.png")));
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try{
			        ...
			        {
			        	JOptionPane.showMessageDialog(null, "Enter Only Charecters");
			        }
			        else
			        {
		...
		btnSave.setBounds(609, 330, 95, 23);
		contentPane.add(btnSave);
		
		JButton btnCancel = new JButton("Cancel");
		btnCancel.setIcon(new ImageIcon(Add_Memberfail.class.getResource("/images/cancel.png")));
		...
		btnCancel.setBounds(714, 330, 107, 23);
		contentPane.add(btnCancel);
		
		JLabel lblAge = new JLabel("Age");
		lblAge.setForeground(Color.BLUE);
		lblAge.setFont(new Font("Traditional Arabic", Font.BOLD, 16));
		lblAge.setBackground(Color.WHITE);
		lblAge.setBounds(194, 201, 118, 20);
		...
		txtOccupation.setBounds(663, 95, 181, 20);
		contentPane.add(txtOccupation);
		
		lblTotalFee = new JLabel("Total Fees");
		lblTotalFee.setForeground(Color.BLUE);
		lblTotalFee.setFont(new Font("Traditional Arabic", Font.BOLD, 16));
		lblTotalFee.setBackground(Color.WHITE);
		lblTotalFee.setBounds(194, 308, 118, 14);
